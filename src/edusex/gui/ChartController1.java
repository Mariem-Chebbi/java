...
//     public  ObservableList<PieChart.Data> buildData() {
        ...
        try {
            ...
            String requete = "SELECT roles, COUNT(*) AS nombre_User FROM user  GROUP BY roles";
...
//     public  ObservableList<PieChart.Data> buildData() {
        ...
        try {
            ...
            String requete = "SELECT DISTINCT date_naissance, COUNT(nom) AS User FROM user GROUP BY nom;";
  ...
  public XYChart.Series buildDataLineChart() {
      XYChart.Series series = new XYChart.Series();
         series.setName("Quantite de User");

        ResultSet rs = null;
       XYChart.Series d;
        try {
            String requete = "SELECT ville, COUNT(*) AS nbre_user_par_ville FROM user GROUP BY ville;";
    ...
    private void detailleProduit() {
        ...
        chart.setTitle("nombre de users par roles ");
    ...
    private void detailleSouscategorie(ActionEvent event) {
        ...
        chart.setTitle("les tranches d'age disponibles");
        ((Group) scene.getRoot()).getChildren().add(chart);
        stage.setScene(scene);
        chartNode.getChildren().clear();
        chartNode.getChildren().setAll(chart);
    ...
    private void lineChart(ActionEvent event) {
        ...
        Stage stage = new Stage();
        Scene scene = new Scene(new Group());
        stage.setTitle("le nombre de user par ville");
        stage.setWidth(600);
        stage.setHeight(600);
